"""
Code Reference: 
https://github.com/TianxiangZhao/GraphSmote/blob/main/utils.py
https://github.com/TianxiangZhao/GraphSmote/blob/main/models.py
"""
...
def recon_upsample(embed, labels, idx_train, adj=None, portion=1.0, tail_classes=[]):
    ...
    for i in tail_classes:
        ...
        for j in range(c_portion):
            ...
            new_labels = labels.new(torch.Size((chosen.shape[0],1))).reshape(-1).fill_(target_label)
